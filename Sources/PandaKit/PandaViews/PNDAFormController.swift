...
//  
//
//  Created by Maarten Wubs on 7/3/22.
//
...
#if os(iOS)
@available(iOS 13.0, *)
open class PNDAFormController: UIViewController {
    ...
    public required init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of PNDAFormController or sublasses of this component from your Storyboard files.")
    }
    ...
    override open func viewDidLoad() {
        ...
        if alignment == .top {
            ...
            formContainerStackView.centerViewInSuperview()
        }
